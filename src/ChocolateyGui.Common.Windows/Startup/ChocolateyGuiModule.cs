...
namespace ChocolateyGui.Common.Windows.Startup
{
	...
	internal class ChocolateyGuiModule : Module
	{
		...
		[SuppressMessage("Microsoft.Maintainability", "CA1506:AvoidExcessiveClassCoupling", Justification = "Not Relevant")]
		protected override void Load(ContainerBuilder builder)
		{
			...
			var mapperConfiguration = new MapperConfiguration(config =>
			{
				...
				config.CreateMap<chocolatey.infrastructure.app.configuration.ChocolateySource, ChocolateySource>()
