...
namespace ChocolateyGui.Common.Windows
{
	...
	public static class NativeMethods
	{
		...
		private static readonly Lazy<BitmapSource> UacIconLazy = new Lazy<BitmapSource>(NativeMethods.GetUacIcon);

		#endregion

		#region Properties

		public static BitmapSource UacIcon => NativeMethods.UacIconLazy.Value;

		#endregion

		#region Public interface

		public static Single GetScaleFactor()
		{
			var desktop = NativeMethods.GetDCCE(IntPtr.Zero);
			var Xdpi = NativeMethods.GetDeviceCaps(desktop, (Int32)DeviceCap.LOGPIXELSX);
			var Ydpi = NativeMethods.GetDeviceCaps(desktop, (Int32)DeviceCap.LOGPIXELSY);
			NativeMethods.ReleaseDC(IntPtr.Zero, desktop);
			return Xdpi / 96f;
		}

		[DllImport("Shlwapi.dll", CharSet = CharSet.Auto)]
		public static extern Int64 StrFormatByteSize(
			Int64 fileSize,
