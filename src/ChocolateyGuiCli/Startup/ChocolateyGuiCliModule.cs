...
namespace ChocolateyGuiCli.Startup
{
	...
	internal class ChocolateyGuiCliModule : Module
	{
		...
		protected override void Load(ContainerBuilder builder)
		{
			...
			builder.RegisterType<DotNetFileSystem>().As<IFileSystem>().SingleInstance();
			...
			builder.RegisterType<FeatureCommand>().As<ICommand>().SingleInstance().Named<ICommand>(ChocolateyGuiCliModule.FeatureCommandName);
			builder.RegisterType<ConfigCommand>().As<ICommand>().SingleInstance().Named<ICommand>(ChocolateyGuiCliModule.ConfigCommandName);
			builder.RegisterType<PurgeCommand>().As<ICommand>().SingleInstance().Named<ICommand>(ChocolateyGuiCliModule.PurgeCommandName);
		}
